                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                ...
                                Invoice {{ $data['order']->invoice_number }}</h1>
                        </td>
                    </tr>
                </table>
                <!--[if (gte mso 9)|(IE)]>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Berikut ringkasan pesanan terbaru anda. Jika anda memiliki pertanyaan
                                atau masalah tentang pesanan anda, silahkan <a
                                    href="{{ route('contact.index') }}">hubungi kami</a>.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                ...
                                @foreach ($data['order']->orderDetail()->get() as $detail)
                                    <tr>
                                        <td align="left" width="75%"
                                            ...
                                            <strong><a
                                                    href="{{ route('product.show', ['categoriSlug' => $detail->Product->category->slug, 'productSlug' => $detail->Product->slug]) }}">{{ $detail->product->name }}</a></strong>
                                        </td>
                                        <td align="left" width="75%"
                                            style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;">
                            ...
                            <div
                                ...
                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td align="left" valign="top"
                                            style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                            <p><strong>Rekening Larisa Shop:</strong></p>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#D2C7BA"
                            ...
                            <p style="margin: 0;">Anda menerima email ini karena kami menerima permintaan untuk
                                mengirim faktur untuk akun anda. Jika anda tidak meminta kirim faktur, anda dapat
                                menghapus email ini dengan aman.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
